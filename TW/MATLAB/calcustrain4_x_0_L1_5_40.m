...
y=load('E:\paper\em two 20180106\data\raw_data_displace4\5L1_FFTCC-ICGN_BC_O8_Data.csv');
v8=y(:,4);%
%[h1,w1]=size(v8);
h2=103;
w2=395;
...
figure;
surf(v88')
M=16;%strain window 2*M+1
GS=5;%grid space
SuSi=20;%subset size SuSi*2+1
MarSi=10;% margin space
%uvalue=0.000000006;
...
y=load('E:\paper\em two 20180106\pattern\Sample14\Sample 14 Commanded Displacement.csv');
v8=y(:,3);
...
jzvalue1=jzvalue*10^(-6);
figure;surf(jzvalue1')
st2=st1-jzvalue1;%
syst=mean2(st2)%
std2=std2(st1)%除以n-1
